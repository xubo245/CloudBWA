...
out='/xubo/project/alignment/CloudBWA/g38/time/cloudBWAnewg38L'$i'c'$j'Nhs20Paired12time'$time'num'$num'k'$k'.sam'
...
#sh testcloudBWAclusterAdam-0.21.1-snapshotjbwa0713.sh $file1 "null" $out $time $num $localseqindex
sh testcloudBWAclusterAdam-0.21.1-snapshotjbwa0713.sh $file1 $file2 $out $time $num $localseqindex
