...
out='/xubo/project/alignment/CloudBWA/g38/time/ERR000589cloudBWAk'$k'.sam'
...
sh testcloudBWAclusterAdam-0.21.1-snapshotGRCH38.sh $file1 $file2 $out $time $num $localseqindex
#~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
done
