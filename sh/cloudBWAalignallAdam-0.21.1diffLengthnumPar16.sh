...
for k in {1..5}
do
out='alluxio://Master:19998/xubo/project/alignment/CloudBWA/g38/time/cloudBWAlongg38L'$i'c'$j'Nhs20Paired12time'$time'num'$num'k'$k'.sam'
~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
file1='alluxio://Master:19998/xubo/project/alignment/sparkBWA/input/g38/longg38L'$i'c'$j'Nhs20Paired.adam'
...
for k in {1..5}
do
out='alluxio://Master:19998/xubo/project/alignment/CloudBWA/g38/time/cloudBWAlongg38L'$i'c'$j'Nhs20Paired12time'$time'num'$num'k'$k'.adam'
~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
file1='alluxio://Master:19998/xubo/project/alignment/sparkBWA/input/g38/longg38L'$i'c'$j'Nhs20Paired.adam'
#file1='alluxio://Master:19998/xubo/project/alignment/sparkBWA/input/g38/newg38L'$i'c'$j'Nhs20Paired1.fastq'
#file2='alluxio://Master:19998/xubo/project/alignment/sparkBWA/input/g38/newg38L'$i'c'$j'Nhs20Paired2.fastq'
