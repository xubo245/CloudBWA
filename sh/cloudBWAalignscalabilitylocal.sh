...
txt='cloudBWAalignscalabilitylocalL'$i'c'$j'time'$time'num'$num'k'$k'time201703301037'
sh testcloudBWAclusterAdam-0.21.1-snapshotscalabilitylocal.sh $file1 "null" $out $time $num $localseqindex > $txt
