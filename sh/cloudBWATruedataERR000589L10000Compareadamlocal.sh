...
#out='alluxio://Master:19998/xubo/project/alignment/CloudBWA/g38/time/ERR000589cloudBWAbatch'$batch'k'$k'.sam'
out='/xubo/project/alignment/CloudBWA/g38/time/ERR000589L10000cloudBWAbatch'$batch'k'$k'.adam'
...
file1='/xubo/project/alignment/sparkBWA/input/ERR000589.L10000.adam'
...
sh testcloudBWAAdamclusterAdam-0.21.1-snapshotGRCH38local.sh $file1 "null" $out $batch $num $localseqindex
#~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
done
