...
#for num in 16 32
for num in 640 560 400 320 240 160 144 128  112 96 80 64 48 32 16
#16 32 48 64 80 96 128 160 240 320 400 480 560 640
#for num in 128
do
...
out='/xubo/project/alignment/CloudBWA/g38/time/ERR000589cloudBWAbatch'$batch'k'$k'.sam'
...
#file1='/xubo/project/alignment/sparkBWA/input/ERR000589.adam'
...
sh testcloudBWAclusterAdam-0.21.1-snapshotGRCH38.sh $file1 $file2 $out $batch $num $localseqindex
#~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
done
