...
//
//import com.github.lindenb.jbwa.jni.jBWA
...
//      var bwaIndex = jBWA.buildIndex(fasta)
//      iter.foreach { each =>
//        var alignmentRecord1 = new Array[AlignmentRecord](1);
//        var alignmentRecord2 = new Array[AlignmentRecord](1);
//        var arr = each._2.toArray
//        var result = jBWA.align(bwaIndex, alignmentRecord1, alignmentRecord2)
//        result.foreach { res =>
//          results.add(res)
//        }
//      }
