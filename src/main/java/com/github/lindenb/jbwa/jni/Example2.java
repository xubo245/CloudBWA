...
//                tmpStr = lineFields(0).substring(1)
            ...
            String read1Name = read1.getName();
            int n = read1Name.length();
            if (read1Name.substring(n - 2).equals("/1") || read1Name.substring(n - 2).equals("/2")) {
                read1.setName(read1Name.substring(0, n - 2));
            }

            String read2Name = read2.getName();
            int m = read2Name.length();
            if (read2Name.substring(m - 2).equals("/1") || read2Name.substring(m - 2).equals("/2")) {
                read2.setName(read1Name.substring(0, m - 2));
            }
